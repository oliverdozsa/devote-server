 ...
 *
 * Blockchain implementations should be placed under galactic.blockchain.[blockchain-package].
 * More precisely, the BlockchainConfiguration class should be placed under galactic.blockchain.[blockchain-package]
