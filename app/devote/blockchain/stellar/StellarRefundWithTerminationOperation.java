...
public class StellarRefundWithTerminationOperation {
    ...
    public void refund(Account destination, List<Account> accountsToTerminate) throws IOException, AccountRequiresMemoException {
        List<Account> filteredAccountsToTerminate = filterAlreadyMergedAccountsFrom(accountsToTerminate);
        ...
        Account txExecutorAccount = filteredAccountsToTerminate.get(0);
    ...
    private List<Account> filterAlreadyMergedAccountsFrom(List<Account> accounts) {
        List<Account> alreadyMergedAccounts = accounts.stream()
