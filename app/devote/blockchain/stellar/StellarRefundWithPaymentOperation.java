...
class StellarRefundWithPaymentOperation {
    ...
    public void refund(Account destination, List<Account> accountsToRefund) throws AccountRequiresMemoException, IOException {
        ...
        Account txExecutorAccount = accountsToRefund.get(0);
